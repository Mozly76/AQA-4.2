...
_Ожидаемый результат:_  Отправка формы успешна.
...
_Ожидаемый результат:_  Форма не отправляется, поля подсвечиваются с ошибкой "Обязательное поле".
...
_Ожидаемый результат:_  Форма не отправляется, поле "Имя" подсвечивается с ошибкой "Должно быть не короче 2 символов".
...
_Ожидаемый результат:_  Форма не отправляется, поле "Имя" подсвечивается с ошибкой "Должно состоять из букв".
...
_Ожидаемый результат:_  Форма не отправляется, поле с номером телефона подсвечивается с ошибкой "Номер в формате +9 (999) 999-99-99".
...
_Ожидаемый результат:_  Форма не отправляется, поле "Электронная почта" подсвечивается с ошибкой "Неверный email".
